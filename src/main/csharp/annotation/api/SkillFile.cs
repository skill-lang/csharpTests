...
using SkillState = annotation.@internal.SkillState;
...
namespace annotation
{
    namespace api
    {
        ...
        public abstract class SkillFile : de.ust.skill.common.csharp.@internal.SkillState, de.ust.skill.common.csharp.api.SkillFile {
            ...
            /// <returns> an access for all Dates in this state </returns>
            public abstract @internal.P0 Dates();

            /// <returns> an access for all Tests in this state </returns>
            public abstract @internal.P1 Tests();
        }
    }
}
