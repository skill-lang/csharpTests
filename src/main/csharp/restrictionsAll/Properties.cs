...
namespace restrictionsAll
{
    ...
    public class Properties : SkillObject {
        private static readonly long serialVersionUID = 0x5c11L + ("properties".GetHashCode()) << 32;
        ...
        public Properties(int skillID) : base(skillID) {
        }
        ...
        /// </summary>
        public new sealed class SubType : Properties , NamedType {
