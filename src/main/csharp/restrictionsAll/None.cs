...
namespace restrictionsAll
{
    ...
    public class None : Properties {
        private static readonly long serialVersionUID = 0x5c11L + ("none".GetHashCode()) << 32;
        ...
        public None(int skillID) : base(skillID) {
        }
        ...
        /// </summary>
        public new sealed class SubType : None , NamedType {
