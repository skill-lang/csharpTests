...
namespace restrictionsAll
{
    ...
    /// </summary>
    public class RegularProperty : Properties {
        private static readonly long serialVersionUID = 0x5c11L + ("regularproperty".GetHashCode()) << 32;
        ...
        public RegularProperty(int skillID) : base(skillID) {
        }
        ...
        /// </summary>
        public new sealed class SubType : RegularProperty , NamedType {
