...
namespace map3
{
    ...
    public class L : SkillObject {
        private static readonly long serialVersionUID = 0x5c11L + ("l".GetHashCode()) << 32;
        ...
        public L(int skillID) : base(skillID) {
        }
        ...
        /// </summary>
        public new sealed class SubType : L , NamedType {
