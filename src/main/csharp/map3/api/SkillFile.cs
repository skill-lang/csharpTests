...
using SkillState = map3.@internal.SkillState;
...
namespace map3
{
    namespace api
    {
        ...
        public abstract class SkillFile : de.ust.skill.common.csharp.@internal.SkillState, de.ust.skill.common.csharp.api.SkillFile {
            ...
            /// <returns> an access for all Ls in this state </returns>
            public abstract @internal.P0 Ls();

            /// <returns> an access for all Ts in this state </returns>
            public abstract @internal.P1 Ts();
        }
    }
}
