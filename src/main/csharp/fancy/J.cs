...
namespace fancy
{
    ...
    public class J : A {
        private static readonly long serialVersionUID = 0x5c11L + ("j".GetHashCode()) << 32;
        ...
        public J(int skillID) : base(skillID) {
        }

        /// <summary>
        /// Used for internal construction, full allocation.
        /// </summary>
        public J(int skillID, de.ust.skill.common.csharp.@internal.SkillObject a, fancy.A Parent) : base(skillID) {
            this.a = a;
          this.Parent = Parent;
        }
        ...
        /// </summary>
        public new sealed class SubType : J , NamedType {
