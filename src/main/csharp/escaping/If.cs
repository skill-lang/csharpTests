...
namespace escaping
{
    ...
    /// </summary>
    public class If : SkillObject {
        private static readonly long serialVersionUID = 0x5c11L + ("if".GetHashCode()) << 32;
        ...
        public If(int skillID) : base(skillID) {
        }
        ...
        /// </summary>
        public new sealed class SubType : If , NamedType {
