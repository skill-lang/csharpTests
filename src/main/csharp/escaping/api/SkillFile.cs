...
using SkillState = escaping.@internal.SkillState;
...
namespace escaping
{
    namespace api
    {
        ...
        public abstract class SkillFile : de.ust.skill.common.csharp.@internal.SkillState, de.ust.skill.common.csharp.api.SkillFile {
            ...
            /// <returns> an access for all ZBooleans in this state </returns>
            public abstract @internal.P0 ZBooleans();

            /// <returns> an access for all Ifs in this state </returns>
            public abstract @internal.P1 Ifs();

            /// <returns> an access for all Ints in this state </returns>
            public abstract @internal.P2 Ints();

            /// <returns> an access for all Z2200s in this state </returns>
            public abstract @internal.P3 Z2200s();
        }
    }
}
