...
using SkillState = container.@internal.SkillState;
...
namespace container
{
    namespace api
    {
        ...
        public abstract class SkillFile : de.ust.skill.common.csharp.@internal.SkillState, de.ust.skill.common.csharp.api.SkillFile {
            ...
            /// <returns> an access for all Containers in this state </returns>
            public abstract @internal.P0 Containers();

            /// <returns> an access for all SomethingElses in this state </returns>
            public abstract @internal.P1 SomethingElses();
        }
    }
}
