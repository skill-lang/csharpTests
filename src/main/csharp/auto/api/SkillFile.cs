...
using SkillState = auto.@internal.SkillState;
...
namespace auto
{
    namespace api
    {
        ...
        public abstract class SkillFile : de.ust.skill.common.csharp.@internal.SkillState, de.ust.skill.common.csharp.api.SkillFile {
            ...
            /// <returns> an access for all NoSerializedDatas in this state </returns>
            public abstract @internal.P4 NoSerializedDatas();
        }
    }
}
