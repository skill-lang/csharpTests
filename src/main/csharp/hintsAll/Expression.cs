...
namespace hintsAll
{
    ...
    /// </summary>
    public class Expression : SkillObject {
        private static readonly long serialVersionUID = 0x5c11L + ("expression".GetHashCode()) << 32;
        ...
        public Expression(int skillID) : base(skillID) {
        }
        ...
        /// </summary>
        public new sealed class SubType : Expression , NamedType {
