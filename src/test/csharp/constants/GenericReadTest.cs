...
namespace constants
{
    ...
    public class GenericReadTest : common.CommonTest {
        ...
        [Test]
        public void test_constants_read_reject_duplicateDefinitionMixed_sf() {
            try {
        ...
        [Test]
        public void test_constants_read_reject_duplicateDefinitionSecondBlock_sf() {
            try {
        ...
        [Test]
        public void test_constants_read_reject_illegalStringPoolOffsets_sf() {
            try {
        ...
        [Test]
        public void test_constants_read_reject_missingUserType_sf() {
            try {
        ...
        [Test]
        public void test_constants_read_reject_nullAsFieldName_sf() {
            try {
